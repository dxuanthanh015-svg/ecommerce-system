...
const SignUp = () => {
  ...
  return (
    ...
    >
      ...
      {/* SignUp Card */}
      <div className="relative z-10 w-full max-w-[450px] bg-white rounded-3xl shadow-2xl p-8 sm:p-10 border border-white/80 my-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-gray-500 font-normal leading-relaxed">
            Join NexCart today for exclusive perks and seamless shopping.
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="John"
                required
                className="w-full bg-[#f0f3fa] border-none focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-xl px-3.5 py-3 text-xs sm:text-sm text-gray-900 placeholder-gray-400 font-normal transition-all"
              />
            </div>
            <div>
              <label className="text-xs font-bold text-gray-700 block mb-1.5">
